...
def appointment_list(request,appointment_id):
    if request.user.__str__()!='AnonymousUser':
        ...
        return render(request,'records/appointment_list.html',{'title':'List of All Appointment','list1':appointments,'item_link':'http://eceuslu.pythonanywhere.com/record/make_appointment/','item_title':'Make Appointment'})
    else:
    ...
    if request.user.__str__()!='AnonymousUser':
        if request.user.corporation_id!=None:
            ...
            return render(request, 'records/busy_day.html', {'data1':data,
                                                 ...
                                                 'item_link': 'http://eceuslu.pythonanywhere.com/corporation/appointment_list/',
...
def show_appointments(request,date):
    if request.user.__str__()!='AnonymousUser':
        ...
        if len(date)==4:
            ...
            y='http://eceuslu.pythonanywhere.com/individual/appointment_list/'+i_c
            z='Appointment List'
        elif len(date)==2:
            ...
            if date=='o':
                ...
                y='http://eceuslu.pythonanywhere.com/individual/appointment_list/'+i_c+'n'
                ...
                y='http://eceuslu.pythonanywhere.com/individual/appointment_list/'+i_c+'o'
...
def most_popular_service(request,date):
    if request.user.__str__()!='AnonymousUser':
        ...
        return render(request, 'records/most_appointer.html', {'data1':data,
                                             ...
                                             'item_link': 'http://eceuslu.pythonanywhere.com/main/service_list/',
    ...
    if request.user.__str__()!='AnonymousUser':
        if rating_id:
            ...
            if request.user.corporation_id!=None:
                ...
                y='http://eceuslu.pythonanywhere.com/record/rate/i'
                z='Rate a Customer'
                ...
                y='http://eceuslu.pythonanywhere.com/record/rate/c'
...
def rate(request,i_c):
    if request.user.__str__()!='AnonymousUser':
        if i_c=='i':
            ...
            return redirect('http://eceuslu.pythonanywhere.com/record/rating_list/')
    else:
        return redirect('http://eceuslu.pythonanywhere.com/')
    ...
    if request.user.__str__()!='AnonymousUser':
        if request.user.corporation_id!=None:
            ...
            return render(request, 'records/busy_hour.html', {'data1':data,
                                                  ...
                                                  'ynamesuffix':' Times',
                                                   'list1': rh_list,
                                                 'item_link': 'http://eceuslu.pythonanywhere.com/corporation/appointment_list/c',
                                                 'item_title': 'Appointment List'})
        else:
            return redirect('http://eceuslu.pythonanywhere.com/')
    else:
